...
[CreateAssetMenu(fileName = "VanguardMonsterData", menuName = "Data/MonsterData/VanguardMonsterData")]
public class VanguardMonsterData : ScriptableObject
{
    public List<VanguardMonsterParam> Data;
}
[Serializable]
public class VanguardMonsterParam : MonsterParam
{
    public Area area;
